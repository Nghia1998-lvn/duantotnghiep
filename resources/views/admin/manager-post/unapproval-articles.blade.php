            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{url('/panel/trang-chu')}}">Trang chủ</a></li>
                                        ...
                                        <table id="example1"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <a href="{{url('/panel/unapproval-articles/active')}}/{{$item->id}}/{{$item->slug}}"
                                                            class="btn btn-info btn-sm"><i class="fas fa-pen-nib"></i>
                                                            Duyệt
                                                            bài viết</a>
                                                        <a class="btn btn-primary btn-sm"
                                                            href="{{url('/panel/unapproval-articles/editer')}}/{{$item->id}}/{{$item->slug}}">
                                                            <i class="fas fa-pencil-alt">
                                                            </i>
                                                            Chỉnh sửa
                                                        </a>
                                                        <a class="btn btn-danger btn-sm click-remove"
                                                            href="{{url('/panel/unapproval-articles/delete')}}/{{$item->id}}">
