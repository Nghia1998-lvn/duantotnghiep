    ...
    <div class="container">
        <div class="row">
            ...
            <div class="ne-sidebar sidebar-break-md col-lg-4 col-md-12">
                ...
                <div class="sidebar-box">
                    <div class="topic-border color-cod-gray mb-30">
                        <div class="topic-box-lg color-cod-gray">Tìm kiếm</div>
                    </div>
                    ...
                    @csrf
                        <div class="input-group stylish-input-group">
                            ...
                            <input type="text" name="key" placeholder="Tìm kiếm bài viết" class="form-control">
                ...
                <div class="sidebar-box">
                    <div class="topic-border color-cod-gray mb-30">
                        <div class="topic-box-lg color-cod-gray">Nhận tin mới</div>
                    </div>
                    <div class="newsletter-area bg-primary">
